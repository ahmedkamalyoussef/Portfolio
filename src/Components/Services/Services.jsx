  ...
  return (
    <section ref={section} className="section services" id="services">
      ...
      <div className="services-container container grid">
        <div className={isScrolled?"services-content-animate animate-delay-1":!check?"services-content-animate":"services-content"} >
        ...
        <div className={isScrolled?"services-content-animate animate-delay-2":!check?"services-content-animate":"services-content"}>
        ...
        <div className={isScrolled?"services-content-animate animate-delay-3":!check?"services-content-animate":"services-content"} >
